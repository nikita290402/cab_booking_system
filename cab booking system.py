    ...
    #===============Define Function==================
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Local Market":
                    switch ={"Railway Station": 10,"Bus Stand": 8,"Arcade Lane":6,"Local Market": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Railway Station":
                    switch ={"Railway Station": 0,"Bus Stand": 2,"Arcade Lane":5,"Local Market": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Bus Stand":
                    switch ={"Railway Station": 2,"Bus Stand": 0,"Arcade Lane":3,"Local Market": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Arcade Lane":
                    switch ={"Railway Station": 5,"Bus Stand": 3,"Arcade Lane":0,"Local Market": 6}
                    Km.set(switch[varl2.get()])        
        ...
        self.cboPickup['value']=('','Local Market','City Hospital','Bus Stand','Railway Station')
        ...
        self.cboDrop['value']=('','Railway Station','Bus Stand','Local Market','City Hospital')
